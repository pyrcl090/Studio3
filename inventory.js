...
item1.addEventListener("click",function() {
    ...
    dimension.innerHTML = "28cm x 20cm x .5cm";
...
item2.addEventListener("click",function() {
    ...
    dimension.innerHTML = "5cm x 2.5cm x 1cm";
...
item3.addEventListener("click",function() {
    ...
    dimension.innerHTML = "17cm x 1cm x 1cm";
...
item4.addEventListener("click",function() {
    ...
    dimension.innerHTML = "16cm x 1cm x 1cm";
...
item5.addEventListener("click",function() {
    ...
    item4.classList.remove("select");
    item.innerHTML = "[bag]";
    dimension.innerHTML = "74cm x 31cm x 2cm ";
    use.innerHTML = "holds all my sh*t ";
